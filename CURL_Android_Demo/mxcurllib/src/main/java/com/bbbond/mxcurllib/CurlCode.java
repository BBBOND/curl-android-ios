...
public enum CurlCode {
  ...
  CURLE_NOT_BUILT_IN(4),             /* 4 - [was obsoleted in August 2007 for 7.17.0, reused in April 2011 for 7.21.5] */
  CURLE_COULDNT_RESOLVE_PROXY(5),    /* 5 */
  CURLE_COULDNT_RESOLVE_HOST(6),     /* 6 */
  CURLE_COULDNT_CONNECT(7),          /* 7 */
  CURLE_WEIRD_SERVER_REPLY(8),       /* 8 */
  CURLE_REMOTE_ACCESS_DENIED(9),     /* 9 a service was denied by the server due to lack of access - when login fails this is not returned. */
  CURLE_FTP_ACCEPT_FAILED(10),       /* 10 - [was obsoleted in April 2006 for 7.15.4, reused in Dec 2011 for 7.24.0]*/
  CURLE_FTP_WEIRD_PASS_REPLY(11),    /* 11 */
  CURLE_FTP_ACCEPT_TIMEOUT(12),      /* 12 - timeout occurred accepting server [was obsoleted in August 2007 for 7.17.0, reused in Dec 2011 for 7.24.0]*/
  CURLE_FTP_WEIRD_PASV_REPLY(13),    /* 13 */
  CURLE_FTP_WEIRD_227_FORMAT(14),    /* 14 */
  CURLE_FTP_CANT_GET_HOST(15),       /* 15 */
  CURLE_HTTP2(16),                   /* 16 - A problem in the http2 framing layer. [was obsoleted in August 2007 for 7.17.0, reused in July 2014 for 7.38.0] */
  ...
  CURLE_PEER_FAILED_VERIFICATION(51),/* 51 - peer's certificate or fingerprint wasn't verified fine */
  ...
  CURLE_SEND_FAIL_REWIND(65),        /* 65 - Sending the data requires a rewind that failed */
  CURLE_SSL_ENGINE_INITFAILED(66),   /* 66 - failed to initialise ENGINE */
  CURLE_LOGIN_DENIED(67),            /* 67 - user, password or similar was not accepted and we failed to login */
  ...
  CURLE_CONV_REQD(76),               /* 76 - caller must register conversion callbacks using curl_easy_setopt options CURLOPT_CONV_FROM_NETWORK_FUNCTION, CURLOPT_CONV_TO_NETWORK_FUNCTION, and CURLOPT_CONV_FROM_UTF8_FUNCTION */
  CURLE_SSL_CACERT_BADFILE(77),      /* 77 - could not load CACERT file, missing or wrong format */
  CURLE_REMOTE_FILE_NOT_FOUND(78),   /* 78 - remote file not found */
  CURLE_SSH(79),                     /* 79 - error from the SSH layer, somewhat generic so the error message will be of interest when this has happened */

  CURLE_SSL_SHUTDOWN_FAILED(80),     /* 80 - Failed to shut down the SSL connection */
  CURLE_AGAIN(81),                   /* 81 - socket is not ready for send/recv, wait till it's ready and try again (Added in 7.18.2) */
  CURLE_SSL_CRL_BADFILE(82),         /* 82 - could not load CRL file, missing or wrong format (Added in 7.19.0) */
  CURLE_SSL_ISSUER_ERROR(83),        /* 83 - Issuer check failed.  (Added in 7.19.0) */
  ...
  CURLE_NO_CONNECTION_AVAILABLE(89), /* 89 - No connection available, the session will be queued */
  CURLE_SSL_PINNEDPUBKEYNOTMATCH(90),/* 90 - specified pinned public key did not match */
