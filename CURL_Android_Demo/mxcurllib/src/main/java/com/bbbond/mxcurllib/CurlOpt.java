...
public interface CurlOpt {
  public enum OptObjectPoint {
    ...
    CURLOPT_XFERINFODATA(CurlConstant.CURLOPT_XFERINFODATA),
    ...
    CURLOPT_STREAM_DEPENDS(CurlConstant.CURLOPT_STREAM_DEPENDS),
    CURLOPT_STREAM_DEPENDS_E(CurlConstant.CURLOPT_STREAM_DEPENDS_E),
    CURLOPT_CONNECT_TO(CurlConstant.CURLOPT_CONNECT_TO),
    ...
    CURLOPT_PROXY_SERVICE_NAME(CurlConstant.CURLOPT_PROXY_SERVICE_NAME),
    CURLOPT_SERVICE_NAME(CurlConstant.CURLOPT_SERVICE_NAME),
    CURLOPT_DEFAULT_PROTOCOL(CurlConstant.CURLOPT_DEFAULT_PROTOCOL),
    CURLOPT_PROXY_CAINFO(CurlConstant.CURLOPT_PROXY_CAINFO),
    CURLOPT_PROXY_CAPATH(CurlConstant.CURLOPT_PROXY_CAPATH),
    CURLOPT_PROXY_TLSAUTH_USERNAME(CurlConstant.CURLOPT_PROXY_TLSAUTH_USERNAME),
    CURLOPT_PROXY_TLSAUTH_PASSWORD(CurlConstant.CURLOPT_PROXY_TLSAUTH_PASSWORD),
    CURLOPT_PROXY_TLSAUTH_TYPE(CurlConstant.CURLOPT_PROXY_TLSAUTH_TYPE),
    CURLOPT_PROXY_SSLCERT(CurlConstant.CURLOPT_PROXY_SSLCERT),
    CURLOPT_PROXY_SSLCERTTYPE(CurlConstant.CURLOPT_PROXY_SSLCERTTYPE),
    CURLOPT_PROXY_SSLKEY(CurlConstant.CURLOPT_PROXY_SSLKEY),
    CURLOPT_PROXY_SSLKEYTYPE(CurlConstant.CURLOPT_PROXY_SSLKEYTYPE),
    CURLOPT_PROXY_KEYPASSWD(CurlConstant.CURLOPT_PROXY_KEYPASSWD),
    CURLOPT_PROXY_SSL_CIPHER_LIST(CurlConstant.CURLOPT_PROXY_SSL_CIPHER_LIST),
    CURLOPT_PROXY_CRLFILE(CurlConstant.CURLOPT_PROXY_CRLFILE),
    CURLOPT_PRE_PROXY(CurlConstant.CURLOPT_PRE_PROXY),
    CURLOPT_PROXY_PINNEDPUBLICKEY(CurlConstant.CURLOPT_PROXY_PINNEDPUBLICKEY),;
  ...
  public enum OptLong {
    ...
    CURLOPT_SERVER_RESPONSE_TIMEOUT(CurlConstant.CURLOPT_SERVER_RESPONSE_TIMEOUT),
    ...
    CURLOPT_SSL_VERIFYSTATUS(CurlConstant.CURLOPT_SSL_VERIFYSTATUS),
    CURLOPT_SSL_FALSESTART(CurlConstant.CURLOPT_SSL_FALSESTART),
    CURLOPT_PATH_AS_IS(CurlConstant.CURLOPT_PATH_AS_IS),
    CURLOPT_PIPEWAIT(CurlConstant.CURLOPT_PIPEWAIT),
    CURLOPT_STREAM_WEIGHT(CurlConstant.CURLOPT_STREAM_WEIGHT),
    CURLOPT_TFTP_NO_OPTIONS(CurlConstant.CURLOPT_TFTP_NO_OPTIONS),
    CURLOPT_TCP_FASTOPEN(CurlConstant.CURLOPT_TCP_FASTOPEN),
    CURLOPT_KEEP_SENDING_ON_ERROR(CurlConstant.CURLOPT_KEEP_SENDING_ON_ERROR),
    CURLOPT_PROXY_SSL_VERIFYPEER(CurlConstant.CURLOPT_PROXY_SSL_VERIFYPEER),
    CURLOPT_PROXY_SSL_VERIFYHOST(CurlConstant.CURLOPT_PROXY_SSL_VERIFYHOST),
    CURLOPT_PROXY_SSLVERSION(CurlConstant.CURLOPT_PROXY_SSLVERSION),
    CURLOPT_PROXY_SSL_OPTIONS(CurlConstant.CURLOPT_PROXY_SSL_OPTIONS),;
